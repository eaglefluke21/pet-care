function Footer () {
    ...
    return (
        ...
        <li>
            <a href="#" className="hover:underline hover:text-blue-800  me-4 sm:me-12">About</a>
        </li>
        <li>
            <a href="#" className="hover:underline hover:text-blue-800 me-4 sm:me-12">Contact</a>
        </li>
        <li>
            <a href="#" className="hover:underline hover:text-blue-800 me-4 sm:me-12">Licensing</a>
        </li>
        <li>
