...
<section className=" rounded-md  ">
            <div className="py-8 px-4 mx-10 max-w-2xl ">
                <h2 className="mb-4 text-xl font-bold text-gray-900 font-quick"> Dog for Adoption</h2>
                ...
                <form >
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div className="w-full">
                            <label className="block mb-2 text-sm font-bold text-gray-900 font-quick ">Age</label>
                            <input type="text"  className="bg-white  text-gray-900 text-sm rounded-lg  block w-full p-2.5 " placeholder="age" required />
                        </div>

                        <div className="w-full">
                            <label className="block mb-2 text-sm font-bold text-gray-900 font-quick">Breed Type</label>
                            <input type="text"  className="bg-white  text-gray-900 text-sm rounded-lg  block w-full p-2.5 " placeholder="Breed" required />
                        </div>
                        <div>
                        ...
                        <div>
                            <label className="block mb-2 text-sm font-bold text-gray-900 font-quick">Diet</label>
                    ...
                    <button type="submit" className="w-full bg-black rounded-md py-1.5 mt-3 font-quick font-semibold shadow-sm shadow-black text-white "> Submit </button>
